...
def get_type(type_number):
    switch = {0: "AVOIDED_CONVERSION", 1: "REFORESTATION", 2: "AFORESTATION", 3:"LAND_CONSERVATION"}
    return switch[type_number]

def get_geo(type_number):
    switch = {0: "CHINA", 1: "FRANCE", 2: "SOUTH_KOREA", 3:"INDIA", 4:"LEBANON"}
    return switch[type_number]

def get_soil(type_number):
    switch = {0: "GRASS", 1: "MANGROVE", 2: "DESERT"}
    return switch[type_number]

def get_trees(type_number):
    switch = {0: "SEQUOIA", 1: "ACACIAS", 2: "JUNGLE_TREES", 3:"KAPOK", 4:"BRAZIL_NUT", 5:"CECROPIA",
              6:"ANNATTO", 7:"CHEWING_GUM_TREE"}
    return switch[type_number]

def get_flood(type_number):
    switch = {0: "LOW", 1: "MEDIUM", 2: "HIGH"}
    return switch[type_number]

def get_fire(type_number):
    switch = {0: "LOW", 1: "MEDIUM", 2: "HIGH"}
    return switch[type_number]

def get_drought(type_number):
    switch = {0: "LOW", 1: "MEDIUM", 2: "HIGH"}
    return switch[type_number]
